...
const ProfileHeader: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start bg-white shadow rounded-lg p-6 mb-4 w-full">
      <img
        src={mockUser.avatar}
        alt="User Avatar"
        className="w-24 h-24 rounded-full border-4 border-blue-500 mb-4 md:mb-0 md:mr-6"
      />
      <div className="flex-1 text-center md:text-left">
        <h2 className="text-2xl font-bold mb-1">{mockUser.name}</h2>
        <p className="text-gray-600 mb-1">{mockUser.title}</p>
        ...
        <div className="flex justify-center md:justify-start space-x-4 mt-2">
          <a href={mockUser.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          ...
          <a href={mockUser.social.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter">
          ...
          <a href={mockUser.social.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub">
